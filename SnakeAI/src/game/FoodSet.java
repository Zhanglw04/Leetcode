...
public class FoodSet {
    ...
    private Vector<Position> foodCoors = new Vector<>();
    ...
    public void produceFood(){
        ...
        for(int i=0; i<amount; i++) {
            Position coordinate = gameUI.randomCoordinate();
        ...
        gameUI.updateInfos("Amount", food.size() + "");
        show();
        System.out.println("Produce " + amount + " foods\t" + Util.getSystemTime());
        for (Position node : foodCoors) {
    ...
    public void readHistory(){
        Vector<Position> coors = gameUI.food_history;
        for (Position coordinate : coors){
            foodCoors.add(coordinate);
    ...
    public int getFoodPoint(Position position){
    ...
    public Vector<Position> getAllFoodCoors(){
        return foodCoors;
    }

    public void removeFoodCoordinate(Position coordinate){
    ...
    public class Food {
        ...
        public Food(int kind, Position coordinate, ImageIcon icon){
            this.kind = kind;
